...
[![Go Report Card](https://goreportcard.com/badge/gitlab.eng.vmware.com/hatchway/govmomi)](https://goreportcard.com/report/gitlab.eng.vmware.com/hatchway/govmomi)
...
[godoc]:http://godoc.org/gitlab.eng.vmware.com/hatchway/govmomi

## Installation

```sh
go get -u gitlab.eng.vmware.com/hatchway/govmomi
```
